...
public class PageTopnReducer extends Reducer<Text, IntWritable, Text, IntWritable>{
	...
	TreeMap<PageCount, Object> treeMapPage = new TreeMap<>();
	...
	protected void reduce(Text key, Iterable<IntWritable> values,
		...
		treeMapPage.put(pageCount, null);
	}
	...
	protected void cleanup(Context context)
		...
		int topn = context.getConfiguration().getInt("top.n", 4);
		
		Set<Entry<PageCount, Object>> entrySet = treeMapPage.entrySet();
